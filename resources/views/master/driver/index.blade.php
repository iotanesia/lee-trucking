                ...
                <div class="card-body">
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group-append">
                            <a type="button" class="input-group-text btn btn-primary btn-border btn-flat" id="search-data" el-event="search-data" data-model="driver"><i class="fa fa-search"></i></a>
                            <a type="button" class="input-group-text btn btn-primary btn-border btn-flat bg-primary text-white"  data-toggle="modal" data-target="#driver-modal"><i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped"  id="table-driver" data-model="driver" request-url="{{ route('api-driver') }}" on-success-load="successLoaddriver">
                            <thead>
                            <tr>
                                <th>Driver Name</th>
                                <th>Status</th>
        ...
        <div class="modal-body">
            <form role="form" id="driver-form">
                ...
                <div class="card-body">
                    ...
                    <input type="text" class="form-control" name="driver_name" id="driver_name" placeholder="driver_name">
                </div>
                <div class="form-group">
