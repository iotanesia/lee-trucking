          ...
          <div class="card" id="moneyTransactionHeader">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table align-items-center table-flush table-striped" id="table-moneyTransactionHeader" api-route="get-list-modal-usaha" data-model="moneyTransactionHeader" request-url="{{ route('api-moneyTransactionHeader') }}" on-success-load="successLoadmoneyTransactionHeader">
    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-body">
            <form role="form" id="moneyTransactionHeader-form">
                ...
                <div class="card-body">
                    <div class="form-group">
                    <label for="moneyTransactionHeader_name">Owner</label>
                ...
                <div class="form-group">
                    <label for="pokok">Modal Usaha</label>
...
<script src="{{asset('js/penanaman-modal.js')}}"></script>
@endsection
