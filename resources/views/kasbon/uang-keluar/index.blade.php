...
<div class="modal fade" id="moneyTransactionHeader-modal-detail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <h5 class="modal-title text-white" id="exampleModalLabel">Detail Uang Keluar</h5>
...
<div class="modal fade" id="moneyTransactionHeader-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <h5 class="modal-title text-white" id="exampleModalLabel">Uang Keluar</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body">
            <form role="form" id="moneyTransactionHeader-form">
                ...
                <div class="card-body">
                    <div class="form-group">
                    <label for="moneyTransactionHeader_name" class="form-control-label">Kategori</label>
                    <select name="category_name" id="user_id" class="form-control">
                        <option value="">Select Kategori</option>
                        <option value="DANA_LAIN_LAIN">Dana Lain - lain</option>
                        <option value="GAJI_KARYAWAN">Gaji Karyawan</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="moneyTransactionHeader_name" class="form-control-label">Jumlah Pengeluaran</label>
                    <div class="input-group input-group-merge">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-money-bill-wave"></i></span>
                        </div>
                        <input type="text" name="pokok" placeholder="Jumlah Pengeluaran" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label for="pokok" class="form-control-label">Tanggal Pengeluaran</label>
                    <div class="input-group input-group-merge">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                        </div>
                        <input type="text" name="date" id="tgl_pinjaman" class="form-control" placeholder="Tanggal Pengeluaran">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="moneyTransactionHeader_name" class="form-control-label">Keterangan</label>
                    <textarea name="keterangan" id="" cols="30" rows="10" class="form-control"></textarea>
                    <!-- <textarea type="text" name="date" id="tgl_pinjaman" class="form-control" placeholder="Tanggal Pengeluaran"></<textarea> -->
                </div>
                <!-- <div class="form-group">
...
<script src="{{asset('js/uang-keluar.js')}}"></script>
@endsection
