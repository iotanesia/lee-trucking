...
class ExportInvoiceBJ implements FromView, WithDrawings
{
...
public function view(): View
{
    ...
    ->select(DB::raw('COUNT("ojk_id") AS rit'),'expedition_activity.tgl_po','ex_wil_kabupaten.kabupaten','expedition_activity.nomor_surat_jalan'
            ,'expedition_activity.ojk_id','ex_master_truck.truck_plat','expedition_activity.nomor_inv'
