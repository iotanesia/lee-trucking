...
(function(g) {
            ...
            if (g.isPlainObject(c)) N(c);
                ...
                if (G) {
                    ...
                    for (f = d.attributes.length - 1; 0 <= f; f--) {
                        ...
                        var k = d.attributes[f].nodeValue; - 1 !== n.indexOf(":") && (e.push({
                            name: n,
                            value: k
                        }), d.removeAttribute(n))
                    }
                    f = 0;
                    for (n = e.length; f < n; f++) k = c.createAttribute(e[f].name.replace(":",
    ...
    w.ext.buttons.excelFlash = g.extend({}, I, {
        ...
        action: function(a, b, c, d) {
            ...
            var k = b.buttons.exportData(d.exportOptions),
                E, C, p = function(h) {
                    ...
                    for (var l = 0, F = h.length; l < F; l++) {
                        ...
                        y || ("number" === typeof h[l] || h[l].match && h[l].match(/^-?\d+(\.\d+)?$/) && !h[l].match(/^0\d+/) ? y = t(e, "c", {
                            attr: {
                                t: "n",
                                r: K
                            },
                        ...
                        }) : (D = h[l].replace ? h[l].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "") : h[l], y = t(e, "c", {
                            attr: {
                                t: "inlineStr",
                                r: K
                            },
            ...
            v = 0;
            for (x = k.header.length; v < x; v++) p.appendChild(t(e, "col", {
                attr: {
                    min: v + 1,
                    max: v + 1,
                    width: S(k, v),
        ...
        g.extend({}, I, {
            ...
            action: function(a, b, c, d) {
                ...
                var f = b.buttons.exportInfo(d),
                    ...
                    n = b.columns(d.columns).indexes().map(function(k) {
